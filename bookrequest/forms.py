...
class BookReqForm(forms.ModelForm):
    ...
    image_s = forms.CharField(widget=forms.TextInput(attrs={'class':'form-control'}))
    image_m = forms.CharField(widget=forms.TextInput(attrs={'class':'form-control'}))
    image_l = forms.CharField(widget=forms.TextInput(attrs={'class':'form-control'}))
    
    class Meta:
        model = BookReq
        fields = ("title", "author", "year", "publisher", "initial_review", "image_s", "image_m", "image_l")