...
async function saveChanges() {
  ...
  if (!username || !email) {
    ...
    var linkElement0 = document.getElementById("usernametextprofiledetailsdropdown1");
    var linkElement1 = document.getElementById("usernametextprofiledetailsdropdown2");
    ...
    linkElement0.textContent = document.getElementById('inputusername').value;
    linkElement1.textContent = document.getElementById('inputusername').value;
